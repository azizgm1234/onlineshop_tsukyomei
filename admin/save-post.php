...
//now finally if all condition good i.e error=false than save-post to database
   if($error===false){
    ...
    $sql="INSERT INTO products 
                      (product_catag,product_title,product_price,product_desc,product_date,product_img,product_left,product_author,animeid)
               VALUES ('{$_POST['prod-category']}','{$_POST['prod-title']}','{$_POST['prod-price']}','{$_POST['prod-desc']}','{$today_date}','{$file_name}','{$_POST['noofitem']}','{$author}','{$_POST['animeid']}');";
