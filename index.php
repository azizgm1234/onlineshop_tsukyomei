      ...
      <div class="row">
        <div class="col-lg-3 col-md-6">
          <a href="#">
            <div class="item">
              <div class="image">
                <img src="./images/featured-01.png" alt="" style="max-width: 44px;margin-top:30px;margin-top:30px;">
              </div>
              <h4>wide Storage</h4>
            </div>
          </a>
        ...
        <div class="col-lg-3 col-md-6">
          <a href="#">
            <div class="item">
              <div class="image">
                <img src="./images/featured-02.png" alt="" style="max-width: 44px;margin-top:30px;">
              </div>
        ...
        <div class="col-lg-3 col-md-6">
          <a href="#">
            <div class="item">
              <div class="image">
                <img src="./images/featured-03.png" alt="" style="max-width: 44px;margin-top:30px;">
              </div>
              <h4>Quic Ready</h4>
            </div>
          </a>
        ...
        <div class="col-lg-3 col-md-6">
          <a href="#">
            <div class="item">
              <div class="image">
                <img src="./images/featured-04.png" alt="" style="max-width: 44px;margin-top:30px;">
              </div>
              <h4>Easy Layout</h4>
            </div>
          </a>
              ...
              <div class="col-lg-12">
                ...
                <div class="search-input">
                  <form id="subscribe" action="#">
                    ...
                    <button href="login.php" type="submit">Subscribe Now</button>
                  </form>
                </div>
              </div>
            </div>
